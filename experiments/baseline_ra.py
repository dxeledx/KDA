...
def main() -> None:
    ...
    logger.info("Running LOSO evaluation (RA)...")
    ...
    logger.info("Running pairwise transfer matrix (RA)...")
    ...
    plot_transfer_matrix(
        matrices["accuracy"],
        fig_dir / "transfer_matrix_ra.pdf",
        title="Cross-Subject Transfer Performance (RA)",
    )
